...
strbuf dw ?,0
_text db "masm32. Федорченко КНЕУ, ІІТЕ 2023р",10,
...
mov n, rv(GetTextDialog," Лабораторна5 Федорченко"," Enter N: ",hIcon) ;Введення N 
mov k, rv(GetTextDialog," Лабораторна5 Федорченко"," Enter K: ",hIcon) ;Введення К
